...
const patchSchema = z.object({
  ...
  prizeWinnerCertification: z.boolean().optional(),
  priorFirstPrizeVerified: z.boolean().optional(),
  languageRequirementVerified: z.boolean().optional(),
...
export async function PATCH(
  ...
  const updated = await updateApplicationProfile({
    ...
    prizeWinnerCertification: parsed.data.prizeWinnerCertification,
    priorFirstPrizeVerified: parsed.data.priorFirstPrizeVerified,
    languageRequirementVerified: parsed.data.languageRequirementVerified,
